...
public enum PokemonSpecies
{
	...
	SQUIRTLE(PokemonType.WATER, PokemonType.NONE, 44, 48, 65, 50, 64, 43),
	...
	private AbstractPokemonGraphics<?> front, back;

	public void setGraphics(AbstractPokemonGraphics<?> front, AbstractPokemonGraphics<?> back)
	{
		this.front = front;
		this.back = back;
	}
